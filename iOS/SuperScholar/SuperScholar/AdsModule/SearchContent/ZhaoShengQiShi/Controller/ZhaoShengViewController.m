...
-(void)creatTableView{
    ...
    self.tableView = [[UITableView alloc]initWithFrame:CGRectMake(0,0 , IEW_WIDTH, IEW_HEGHT-kNavigationbarHeight-44) style:UITableViewStyleGrouped];
    ...
    [self.tableView setSeparatorColor:HexColor(0xeeeeee)];
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    if (indexPath.row<10) {
        ...
        //设置文字颜色
        [attributStr addAttribute:NSForegroundColorAttributeName value:HexColor(0x333333) range:NSMakeRange(0, attributStr.length)];
        //设置文字大小
        [attributStr addAttribute:NSFontAttributeName value:[UIFont systemFontOfSize:16] range:NSMakeRange(0, attributStr.length)];
