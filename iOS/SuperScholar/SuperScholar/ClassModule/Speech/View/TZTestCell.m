...
- (instancetype)initWithFrame:(CGRect)frame {
    ...
    if (self) {
        ...
        _tipIconImageView.image = [UIImage imageNamed:@"AlbumAddBtn"];
        [self addSubview:_tipIconImageView];
...
- (void)layoutSubviews {
    ...
    _tipIconImageView.tz_size = CGSizeMake(self.tz_height*2/5, width);
    _tipIconImageView.center = CGPointMake(self.tz_width/2.0, self.tz_height*2/5);
    _tipIconImageView.frame = self.bounds;
    _tipLabel.tz_size = CGSizeMake(self.tz_width, 30);
    _tipLabel.tz_top = _tipIconImageView.tz_bottom;
}
