...
@interface ContactChatListManager ()
@property (strong, nonatomic) NSMutableArray *contactIDs;
@end

@implementation ContactChatListManager

+ (instancetype)defaultManager {
    static ContactChatListManager *defaultManager = nil;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        defaultManager = [[ContactChatListManager alloc] init];
    });
